...
export function UserAction() {
  return (
    <div className="flex sm:flex-row flex-col border-[#06624d] border-2 rounded-tl-lg rounded-tr-lg">
      <Link
        href="/ouvidoria"
        className="cursor-pointer sm:h-36 h-28 w-64 bg-[#06624d] rounded-tl-md p-5 flex justify-start items-center"
      >
        <div className="flex sm:flex-col items-center sm:items-start w-36 h-16 p-0">
          <Image
            alt="Ouvidoria"
            src="/ouvidoria.png"
            width={40}
      ...
      <Link
        href="/esic"
        className="cursor-pointer sm:h-36 h-28 w-64 p-5 flex justify-start items-center"
      >
        <div className="flex sm:flex-col items-center sm:items-start w-36 h-16 p-0">
          <Image
      ...
      <DividerY />
      <div className=" cursor-pointer sm:h-36 h-28 w-64 p-5 flex justify-start items-center">
        <div className="flex sm:flex-col items-center sm:items-start w-36 h-16 p-0">
          <Image
